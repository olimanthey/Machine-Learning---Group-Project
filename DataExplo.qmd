...
1.  **Feature Selection & Reduction**
    ...
    -   Consider removing `engine_id` and `tempstamp`(non-informative)
    -   Transform categorical variables for one-hot encoding or target encoding
    -   See how features behave with one another
2.  **Outlier Strategy**
